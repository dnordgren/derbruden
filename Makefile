...
deploy-static:
	...
	@aws s3 sync static/ s3://$(BUCKET)/static/ --delete --exclude "data/trades.json" --exclude "data/waivers.json" --exclude "data/alltime-records.json" --exclude "data/games.json" --cache-control "public, max-age=31536000, immutable"
